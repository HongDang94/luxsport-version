...
$.scrollLock = (function () {
  ...
  var l = $("html"),
    ...
    s = {},
    c = { "overflow-y": "auto", position: "fixed", width: "100%" };
  function r() {
    var o,
      t = l.attr("style"),
      c = {};
  ...
  function n() {
    ...
    o ||
      ...
      r(),
      $.extend(s, c, { left: -t.scrollLeft + "px", top: -t.scrollTop + "px" }),
      l.css(s),
  ...
  function e() {
    o &&
      (l.attr("style", $("<x>").css(s).attr("style") || ""),
      $(window).scrollLeft(t.scrollLeft).scrollTop(t.scrollTop),
      (o = !1));
  }
  return (
    r(),
